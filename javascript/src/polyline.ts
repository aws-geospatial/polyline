...
export class FlexiblePolyline extends DataCompressor {
    readonly FLEXPOLYLINE_ENCODING_TABLE = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
    readonly encoder = new PolylineEncoder(this.FLEXPOLYLINE_ENCODING_TABLE, true);
    ...
    encodeFromLngLatArray(
        ...
        // Validate parameters.
        if (fullParameters.precisionLngLat < 0 || fullParameters.precisionLngLat > 15) {
            throw new Error(
...
abstract class Polyline extends DataCompressor {
    readonly precision:number;
    readonly POLYLINE_ENCODING_TABLE = "?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
